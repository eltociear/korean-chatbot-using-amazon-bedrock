...
def get_prompt_template(query, conv_type, rag_type):
    ...
    if word_kor and word_kor != 'None':
        if conv_type == "normal": # for General Conversation
            ...
            prompt_template = """\n\nHuman: 다음의 <context></context>안의 내용은 참고자료에서 가져온 텍스트입니다. 참고자료로 부터 구체적인 세부 정보를 충분히 제공합니다. Assistant의 이름은 서연이고, 모르는 질문을 받으면 솔직히 모른다고 말합니다. 결과에 "네"를 비롯한 불필요한 부가정보를 절대 포함하지 마세요.
